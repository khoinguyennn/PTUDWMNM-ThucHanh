        ...
        <div class="col-lg-9 col-md-8 main-content">
           ...
           <!-- Exercise -->
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <p><strong>Yêu cầu:</strong> Hãy sử dụng ngôn ngữ PHP để viết xử lý chương trình mô phỏng một máy tính đơn giản, thực hiện các phép tính cộng, trừ, nhân, chia, phép chia lấy dư. Lưu bài tập với tên bai2.php
                        <img src="../img/bt1.png">
                    </p>
                </div>
            </div>
